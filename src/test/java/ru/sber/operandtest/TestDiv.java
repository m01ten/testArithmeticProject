...
@Title("Тестируем строки с операциями делений")
public class TestDiv {
	...
	public double getResult(double oper1, double oper2) {
		assertFalse("Деление на 0.", oper2 == 0);
	...
	public void validate(double expectedSumm, double summFromFile) {
		assertTrue("Сравнение прошло некорректно: " + expectedSumm
				+ " не соответсвует " + summFromFile,
